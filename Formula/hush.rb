class Hush < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/kdrag0n/hush/releases/download/prerelease-main/hush-hush-macos-aarch64",
        using: :nounzip
    sha256 "a9feb2e99166e3613ea60860c13fc56b8dcdd3cde8a32c0982042ff32a9c1b8f"

    resource "hush-server" do
      url "https://github.com/kdrag0n/hush/releases/download/prerelease-main/hush-server-hush-macos-aarch64",
          using: :nounzip
      sha256 "eeaaf847ef33b4d31a118a0293005c206a408d6cbec1e236fb1e0470290a4e5c"
    end
  elsif OS.linux? && Hardware::CPU.arm?
    url "https://github.com/kdrag0n/hush/releases/download/prerelease-main/hush-hush-linux-aarch64-musl",
        using: :nounzip
    sha256 "d485fb2ee8bf9594ee76f09a07ba428c4a8cad8c79cbab6ea1abe7f8a463d383"

    resource "hush-server" do
      url "https://github.com/kdrag0n/hush/releases/download/prerelease-main/hush-server-hush-linux-aarch64-musl",
          using: :nounzip
      sha256 "7ab4ee3710daa191940334b54513c38d34b5a9f9cfb7f31dfafca7491622bdfe"
    end
  elsif OS.linux? && Hardware::CPU.intel?
    url "https://github.com/kdrag0n/hush/releases/download/prerelease-main/hush-hush-linux-x86_64-musl",
        using: :nounzip
    sha256 "8f208b9c5a0151d82db8d622eb02e36db7183f81ba2acdc024baef93e6d1b27b"

    resource "hush-server" do
      url "https://github.com/kdrag0n/hush/releases/download/prerelease-main/hush-server-hush-linux-x86_64-musl",
          using: :nounzip
